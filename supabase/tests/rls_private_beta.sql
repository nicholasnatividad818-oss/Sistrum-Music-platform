...
begin
  ...
  begin
    ...
    values ('00000000-0000-0000-0000-00000000a001', '00000000-0000-0000-0000-00000000b003');
    raise exception 'User A liked hidden User B track';
  exception when insufficient_privilege then null;
  end;
  begin
    insert into public.track_reposts (user_id, track_id)
    values ('00000000-0000-0000-0000-00000000a001', '00000000-0000-0000-0000-00000000b003');
    raise exception 'User A reposted hidden User B track';
  exception when insufficient_privilege then null;
  end;
  begin
    update public.profiles set is_verified = true where id = '00000000-0000-0000-0000-00000000a001';
    raise exception 'User A self-verified';
  exception when insufficient_privilege then null;
  end;
  begin
    update public.tracks set play_count = 999 where id = '00000000-0000-0000-0000-00000000b001';
    raise exception 'User A forged play count';
  exception when insufficient_privilege then null;
  end;
